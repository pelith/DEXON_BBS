<template>
    <base-template>
        <template slot="style">
            ...
            <link href="../assets/termptt/pttchrome.b15553e228202ffb8a97.css" rel="stylesheet">
        </template>
...
export default {
  ...
  head: {
    ...
    script: [
      { type: 'text/javascript', src: 'https://code.jquery.com/jquery-3.2.1.min.js', body: true},
      { type: 'text/javascript', src: 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', body: true},
    ]
  },
}
</script>
...
<style>
    @media (min-width: 993px) {
        .main {
            font-family: Inconsolata, MingLiU, SymMingLiU, 'AR PL UMing TW', LiSongPro, monospace;
        }
        button {
            height: 26px;
            border: 0 none;
