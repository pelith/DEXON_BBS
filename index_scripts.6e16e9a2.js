...
},{"@babel/runtime/regenerator":"PMvg"}],"FO+Z":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            BBS = new _dexon.web3js.eth.Contract(_dexon.ABIBBS, _dexon.BBSContract);
            BBSExt = new _dexon.web3js.eth.Contract(_dexon.ABIBBSExt, _dexon.BBSExtContract);
            _context3.next = 6;
            return BBS.getPastEvents({
              fromBlock: '1170000'
            });
          ...
          case 6:
            ...
            function () {
              ...
              _regenerator.default.mark(function _callee(event) {
                var txHash, transaction, block, votes;
                return _regenerator.default.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 3;
                        return _dexon.web3js.eth.getTransaction(txHash);
                      ...
                      case 6:
                        block = _context.sent;
                        _context.next = 9;
                        return countVotes(event.transactionHash);

                      case 9:
                        votes = _context.sent;
                        return _context.abrupt("return", [event.returnValues.content, txHash, transaction.from, block.timestamp, votes]);
...
function () {
  ...
  _regenerator.default.mark(function _callee4(txHash) {
    var BBSExt, tx, upvotes, downvotes;
    return _regenerator.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            BBSExt = new _dexon.web3js.eth.Contract(_dexon.ABIBBSExt, _dexon.BBSExtContract);
            tx = txHash.substr(0, 66);
            _context4.next = 4;
            return BBSExt.methods.upvotes(tx).call();

          case 4:
            upvotes = _context4.sent;
            _context4.next = 7;
            return BBSExt.methods.downvotes(tx).call();

          case 7:
            downvotes = _context4.sent;
            return _context4.abrupt("return", upvotes - downvotes);
  ...
  return function countVotes(_x4) {
    return _ref4.apply(this, arguments);
  };
}();

var directDisplay = function directDisplay(content, txHash, from, timestamp, votes) {
  content = (0, _utils.htmlEntities)((0, _utils.getTitle)(content.substr(0, 42)).title);
  var elem = $('<div class="r-ent"></div>');
  elem.html("<div class=\"nrec\"></div>\n    <div class=\"title\">\n    <a href=\"content.html?tx=".concat(txHash, "\">\n      ").concat(content, "\n    </a>\n    </div>\n    <div class=\"meta\">\n      <div class=\"author\">\n        <a>\n          ").concat((0, _utils.getUser)(from), "\n        </a>\n      </div>\n      <div class=\"article-menu\"></div>\n      <div class=\"date\">...</div>\n    </div>"));
