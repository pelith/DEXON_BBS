...
},{"@babel/runtime/regenerator":"PMvg"}],"DCbj":[function(require,module,exports) {
"use strict";
...
var checkContent = function checkContent() {
  return $("#bbs-content").val().length > 0;
};

var checkTitle = function checkTitle() {
  return $("#bbs-title").val().length > 0;
};
...
function main() {
  ...
  $("#bbs-title").blur = function () {
    $("#bbs-title").val((0, _utils.getParseText)($("#bbs-title").val(), 40));
  };
